...
class TagsDirectClientV1 extends pip_services_rpc_node_1.DirectClient {
    constructor(config) {
        super();
        this._dependencyResolver.put('controller', new pip_services_commons_node_2.Descriptor("pip-services-tags", "controller", "*", "*", "*"));
        if (config != null)
